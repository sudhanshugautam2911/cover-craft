...
// Learning - whole component is just amazing - rnd ( for dragable and adjustable images )
    ...
    async function saveConfiguration() {
        try {
            const {
                ...
                width,
                height,
            } = phoneCaseRef.current!.getBoundingClientRect()   // This will give us exact dimension of our phone area
            // left (distance from left till the ref)
            // top (distance from top till the ref)

            const { left: containerLeft, top: containerTop } = containerRef.current!.getBoundingClientRect()

            const leftOffset = caseLeft - containerLeft   // left distance between container and mobile.
            const topOffset = caseTop - containerTop     // top distance between container and mobile.
        ...
        <div className='relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20'>
            <div
                ...
                <div className='relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]'>
                    {/* shadcn component to always maintain same aspect ratio */}
                ...
                <Rnd
                    ...
                    // if we dont need a parameter than represented by __
                ...
                >
                    <div className="relative w-full h-full">
                        <NextImage fill alt='your image' src={imageUrl} className="pointer-events-none" />
                    </div>
                </Rnd>
            </div>
                        ...
                        <div className='relative mt-4 h-full flex flex-col justify-between'>
                            <div className='flex flex-col gap-6'>
                                ...
                                {[MATERIALS, FINISHES].map(
                                    // just rename options as selectableOptions
